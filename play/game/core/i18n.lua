...
local DEFAULT_LOCALES = {
	en = {
		...
		["hud.hint.bidding"] = "← → count · ↑ ↓ face · [Space] Pass · [C] Challenge",
		["hud.hint.bidding_skull"] = "Skull: judged as half the count (round down) · [Space] Pass · [C] Challenge",
	...
	ko = {
		...
		["hud.hint.bidding"] = "← → 수량 · ↑ ↓ 눈 · [Space] 넘기기 · [C] 결투신청",
		["hud.hint.bidding_skull"] = "Skull: 현재 수량의 절반(내림)으로 판정 · [Space] 넘기기 · [C] 결투신청",
	...
	ja = {
		...
		["hud.hint.bidding"] = "← → 数 · ↑ ↓ 出目 · [Space] パス · [C] 決闘",
		["hud.hint.bidding_skull"] = "Skull: 数の半分（切り捨て）で判定 · [Space] パス · [C] 決闘",
		["hud.hint.duel"] = "決闘中です。",
