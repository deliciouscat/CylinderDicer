...
export interface ConvexRuntimeConfig {
  url: string
  useConvexDev: boolean
}

export function readConvexRuntimeConfig(env = import.meta.env): ConvexRuntimeConfig {
...
export function createBrowserConvexClient(config = readConvexRuntimeConfig()): ConvexClient {
